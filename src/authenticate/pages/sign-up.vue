<template>
                    ...
                    <v-form ref="form" v-model="valid" lazy-validation>
                      ...
                      >
                        <template v-slot:append>
                          <v-tooltip right>
                            <template v-slot:activator="{ on }">
                              <v-icon v-on="on">mdi-map-marker-outline</v-icon>
                            </template>
                            Write here your farm address
                          </v-tooltip>
                        </template>
                      </v-text-field>
  ...
  <script>
  import AuthService from "@/authenticate/services/sign-up.service";
  ...
  export default {
    ...
    data: () => ({
      ...
      farmRules: [ v => !!v || 'Farm Address is required'],
      ageRules: [
        v => !!v || 'Age is required',
